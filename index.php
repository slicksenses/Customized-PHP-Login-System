...
?>
        ...
        <div class="android-be-together-section mdl-typography--text-center">
            ...
            <div class="logo-font android-sub-slogan">welcome to php... be yourself. do your thing. see what's going on.</div>
            <div class="logo-font android-create-character">
                <a href=""><img src="<?= $config->asset('images/wear-silver-on.png') ?>"> create your web app</a>
            </div>
            ...
            <div class="android-screens">
                <div class="android-wear android-screen">
                    <a class="android-image-link" href="">
                        <img class="android-screen-image" src="<?=  $config->asset('images/wear-silver-on.png') ?>">
                        <img class="android-screen-image" src="<?= $config->asset('images/wear-black-on.png') ?>">
                    </a>
                ...
                <div class="android-phone android-screen">
                    <a class="android-image-link" href="">
                        <img class="android-screen-image" src="<?= $config->asset('images/nexus6-on.jpg') ?>">
                    </a>
                ...
                <div class="android-tablet android-screen">
                    <a class="android-image-link" href="">
                        <img class="android-screen-image" src="<?= $config->asset('images/nexus9-on.jpg') ?>">
                    </a>
                ...
                <div class="android-tv android-screen">
                    <a class="android-image-link" href="">
                        <img class="android-screen-image" src="<?= $config->asset('images/tv-on.jpg') ?>">
                    </a>
                ...
                <div class="android-auto android-screen">
                    <a class="android-image-link" href="">
                        <img class="android-screen-image" src="<?= $config->asset('images/auto-on.jpg') ?>">
                    </a>
            ...
            <div class="android-card-container mdl-grid">
                <div class="mdl-cell mdl-cell--3-col mdl-cell--4-col-tablet mdl-cell--4-col-phone mdl-card mdl-shadow--3dp">
                    <div class="mdl-card__media">
                        <img src="<?= $config->asset('images/more-from-1.png') ?>">
                    </div>
                ...
                <div class="mdl-cell mdl-cell--3-col mdl-cell--4-col-tablet mdl-cell--4-col-phone mdl-card mdl-shadow--3dp">
                    <div class="mdl-card__media">
                        <img src="<?= $config->asset('images/more-from-4.png') ?>">
                    </div>
                    <div class="mdl-card__title">
                ...
                <div class="mdl-cell mdl-cell--3-col mdl-cell--4-col-tablet mdl-cell--4-col-phone mdl-card mdl-shadow--3dp">
                    <div class="mdl-card__media">
                        <img src="<?= $config->asset('images/more-from-2.png') ?>">
                    </div>
                    <div class="mdl-card__title">
                ...
                <div class="mdl-cell mdl-cell--3-col mdl-cell--4-col-tablet mdl-cell--4-col-phone mdl-card mdl-shadow--3dp">
                    <div class="mdl-card__media">
                        <img src="<?= $config->asset('images/more-from-3.png') ?>">
                    </div>
                    <div class="mdl-card__title">
